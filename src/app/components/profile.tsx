...
const Profile: React.FC<profileProps> = ({username, isAuthenticated}) => {
    return (
        <a href={isAuthenticated?"./profile":"/."} className="p-1 rounded-md hover:bg-white hover:text-black cursor-pointer self-center">
            {username?(
