...
const Profile: React.FC<profileProps> = ({username, isAuthenticated, user_id}) => {
    return (
        <a href={isAuthenticated?`./profile/${user_id}`:"/."} className="p-1 rounded-md hover:bg-white hover:text-black cursor-pointer self-center">
            {username?(
